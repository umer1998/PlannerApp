...
class AppColors {
  ...
  static const bgBlue = Color(0xff4a7afa);

  static const bgYellow = Color(0xffff9c48);

  static const bgGreen = Color(0xff3eaa92);

  static const greenText = Color(0xff0F6742);
